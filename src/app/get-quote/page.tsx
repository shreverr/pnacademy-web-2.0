...
export default function AssessmentForCorporate() {
  return (
    <main className="mt-8 flex flex-col items-center justify-center mx-10 mb-10 gap-4 min-h-[38rem]">
      <AnimationContainer delay={0.1}>
        <button className="group relative grid overflow-hidden rounded-full px-4 py-1 shadow-[0_1000px_0_0_hsl(0_0%_20%)_inset] transition-colors duration-200">
          ...
          <span className="z-10 py-0.5 text-sm text-neutral-100 flex items-center justify-center gap-1">
            Get Quote
            <CreditCard className="ml-1 size-3 transition-transform duration-300 ease-in-out group-hover:translate-x-0.5" />
          </span>
        </button>
      </AnimationContainer>
      ...
      <div className="flex flex-col 2xl:flex-row items-center gap-4 justify-center w-full">
        ...
        >
          ...
          <article className="text-white pt-2 w-2/3 mx-auto block text-center z-10 relative">
            ...
            <p>
              Simplify corporate assessments with advanced proctoring, detailed
              analytics, customizable reports, and seamless integration.
            </p>
          </article>
          <div className="w-full p-10">
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-10">
              ...
              <GlowingStarsCard
                ...
                description={
                  "Monitor candidates in real-time with AI-powered proctoring."
                }
