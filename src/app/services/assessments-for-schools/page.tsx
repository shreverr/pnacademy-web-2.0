      ...
      <AnimationContainer delay={0.1}>
        <button className="group relative grid overflow-hidden rounded-full px-4 py-1 shadow-[0_1000px_0_0_hsl(0_0%_20%)_inset] transition-colors duration-200">
          ...
          <span className="z-10 py-0.5 text-sm text-neutral-100 flex items-center justify-center gap-1">
            ...
            <BookOpen className="ml-1 size-3 transition-transform duration-300 ease-in-out group-hover:translate-x-0.5" />
          </span>
        </button>
      </AnimationContainer>
      ...
      <div className="flex flex-col 2xl:flex-row items-center gap-4 justify-center w-full">
        ...
        >
          ...
          <article className="text-white pt-2 w-2/3 mx-auto block text-center z-10 relative">
            ...
            <p>
              Modernize school assessments with intuitive tools, robust
              proctoring, customizable reports, and user-friendly management.
            </p>
          </article>
          <div className="w-full p-10">
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-10">
              <GlowingStarsCard
                ...
                description={
                  "Prevent cheating with secure browser lockdown and advanced proctoring."
                }
              ...
              <GlowingStarsCard
                ...
                description={
                  "Analyze student performance with detailed insights and reports."
                }
                icon={<PieChart className="size-5" />}
              />
              <GlowingStarsCard
                title={"User-Friendly Test Creation "}
                description={
                  "Create tests with ease, add questions, set time limits, and customize test settings."
                }
